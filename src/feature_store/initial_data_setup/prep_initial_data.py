...
in Hugging Face, which generated by generate_initial_data.py
"""
...
def main(config_yaml_abs_path: str, data_dir: PosixPath):
    ...
    raw_dataset_features_file_name = config.params["files"]["params"][
        "raw_dataset_features_file_name"
    ]
    ...
    raw_features.to_parquet(
        data_dir / raw_dataset_features_file_name,
        index=False,
    )
    ...
    raw_target.to_parquet(
        data_dir / raw_dataset_target_file_name,
        index=False,
    )
